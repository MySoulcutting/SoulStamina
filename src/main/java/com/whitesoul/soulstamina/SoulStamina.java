...
public final class SoulStamina extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        // 初始化数据库
        SQL.createTable("soulstamina",new String[]{"uuid","playerName","stamina","maxStamina"},new String[]{"VARCHAR(255)","VARCHAR(255)","INT","INT"},new String[]{"NOT NULL","NOT NULL","NOT NULL","NOT NULL"});
        Log.info("§a启动完成！");
    }
    @Override
